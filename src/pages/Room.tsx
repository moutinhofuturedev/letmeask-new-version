...
export function Room() {
    ...
    function backHome() { // esta função faz retornar a página Home quando clica na imagem da Logo
        history.push('/')
    }
    ...
    return(
        <div id="page-room">
            ...
            <main>
                ...
                <form onSubmit={handleSendQuestion}> {/* o formulário esta invertido */}
                    <div className="form-footer"> {/* está div está invertida ao textarea */}
                        { user ? (
                            <div className="user-info">
                                <img src={user.avatar} /> {/* quando aparecer a imagem na Room colocar a propriedade 'alt' */}
                                <span>{user.name}</span>
                            </div>
                        ) : (
